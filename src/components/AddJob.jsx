...
const AddJob = () => {
  ...
  const uploadJob = async (e) => {
    e.preventDefault();
    console.log("Submitting:", name, jobtype, joblocation, description, salary, logo);
  
    if (!name || !jobtype || !joblocation || !salary || !description || !logo) {
    ...
    try {
      ...
      const response = await axios.post(
        ...
        {name , jobtype , joblocation , salary , description , logo},
        {
          headers: {
  ...
  return (
    <div>
      <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
        ...
        <form action="" onSubmit={uploadJob} method="post">
